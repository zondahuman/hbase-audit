 ...
 */
public class CallQpsBatchTest {
    private static final String httpUrl = "http://localhost:8111/sentinel/callQpsBatch";


            @Test
    public void testCallQpsBatch() {
        try {
...
//            }
    ...
    public String concurrencyCallQps() {
        String result = "";
        try {
            CloseableHttpClient httpClient = HttpClientUtil.getHttpClient();
            HttpPost httpPost = new HttpPost(httpUrl);
