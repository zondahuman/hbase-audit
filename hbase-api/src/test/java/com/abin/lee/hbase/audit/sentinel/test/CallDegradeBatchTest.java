 ...
 */
public class CallDegradeBatchTest {
    private static final String httpUrl = "http://localhost:8111/sentinel/callDegradeBatch";


            @Test
    public void testCallDegradeBatch() {
        try {
            ...
            nvps.add(new BasicNameValuePair("total", "1000000"));
            nvps.add(new BasicNameValuePair("qps", params));
            nvps.add(new BasicNameValuePair("sleepTime", "1000"));
...
//            System.out.println(EntityUtils.toString(response.getEntity()));
    ...
    @Test
    public void testConcurrencyCallDegradeBatch() throws ExecutionException, InterruptedException {
        Integer total = 2000;
