...
import com.abin.lee.hbase.audit.api.service.UserAuditService;
...
public class UserAuditController {
    ...
    protected final static Logger logger = LoggerFactory.getLogger(UserAuditController.class);
...
//    HbaseAuditService hbaseAuditService;
    ...
    public String addRow(String tableName, String columnFamily, String driverId, String logStatus, String logType, long timeStamp, String params) {
        ...
        try {
            ...
            this.userAuditService.addRow(tableName, columnFamily, driverId, logStatus, logType, timeStamp, paramsInput);
        } catch (Exception e) {
            logger.error("e={}", e);
            return "FAILURE";
        }
    ...
    public String insertRow(String tableName, String columnFamily, String driverId, String logStatus, String logType, long timeStamp, String params) {
        ...
        try {
            ...
            this.userAuditService.insertRow(tableName, columnFamily, driverId, logStatus, logType, timeStamp, paramsInput);
        } catch (Exception e) {
            logger.error("e={}", e);
            return "FAILURE";
        }
    ...
    public String get(String tableName, String driverId, String logStatus, String logType, long timeStamp) {
        ...
        long start = System.currentTimeMillis();
        try {
//            this.userAuditService.getRow(tableName, driverId, logStatus, logType, timeStamp);
        } catch (Exception e) {
            logger.error("e={}", e);
            return "FAILURE";
        }
    ...
    public List<UserBean> findAll(String tableName, String columnFamily) {
        ...
        try {
            list = this.userAuditService.findAll(tableName, columnFamily);
        } catch (Exception e) {
            logger.error("e={}", e);
        }
    ...
    public UserBean findOne(String tableName, String rowName) {
        ...
        UserBean bean = null;
        try {
            bean = this.userAuditService.findOne(tableName, rowName);
        } catch (Exception e) {
            logger.error("e={}", e);
        }
    ...
    public List<UserBean> findByCondition(String tableName, String driverId, String logStatus, String logType, String startTimeStamp, String endTimeStamp) {
        ...
        List<UserBean> list = null;
        try {
            list = this.userAuditService.findByCondition(tableName, driverId, logStatus, logType, startTimeStamp, endTimeStamp);
        } catch (Exception e) {
            logger.error("e={}", e);
        }
