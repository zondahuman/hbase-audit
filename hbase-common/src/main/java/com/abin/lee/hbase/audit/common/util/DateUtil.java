package com.abin.lee.hbase.audit.common.util;
...
public class DateUtil {
    ...
    public static String getSomeDate(Integer param) {
        String result = "";
        Calendar calendar = Calendar.getInstance();
        try {
//            calendar.setTime(new Date());
            calendar.add(Calendar.DATE, param);
            result = DateFormatUtils.format(calendar.getTime(), ymdhmsSdf);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
